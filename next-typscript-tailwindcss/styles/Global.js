const styles = {
  ...
  buttonHover:
    " hover:bg-white hover:border-violet-800 hover:text-violet-900 hover:cursor-pointer",
  ...
  greenBtn: "text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-1 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2",
